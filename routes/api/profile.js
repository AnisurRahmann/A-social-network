...
router.get("/all", (req, res) => {
  ...
  Profile.find()
    ...
    .catch(err => res.status(404).json({ profile: "thre is no profile" }));
});
...
//@desc   create or edite users profiles
//@access   private
...
//@desc   cadd experience to the proife
//@access   private
...
router.post(
  ...
  (req, res) => {
    ...
    Profile.findOne({ user: req.user.id }).then(profile => {
      ...
      //add to exp array unshift(used instead of push that will add the array in the front)
...
//@desc   add education to the proife
//@access   private
